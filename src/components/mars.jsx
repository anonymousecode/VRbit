    ...
    <div style={{ position: 'relative', width: '100vw', height: '100vh', overflow: 'hidden' }}>
      ...
      {showInfo && (
        ...
        >
          ...
          <h1 style={{ fontSize: '2.5rem', marginBottom: '1rem' }}>About Mars</h1>
            ...
            It is a cold, desert-like planet with the largest volcano and canyon in the solar system.
            Mars has a thin atmosphere composed mostly of carbon dioxide and is a prime target in the search for past or present life.
            </p>
            ...
            <li><strong>Orbital Period:</strong> 687 Earth days</li>
            <li><strong>Satellites:</strong> Phobos and Deimos</li>
            </ul>
