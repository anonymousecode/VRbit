    ...
    <div style={{ position: 'relative', width: '100vw', height: '100vh', overflow: 'hidden' }}>
      ...
      >
        ...
        <a-sphere
          ...
          position="0 1 -3"
          radius="4"
          src="/images/mercury-texture.jpg"
          rotation="0 0 0"
      ...
      {showInfo && (
        ...
        >
          ...
          <h1 style={{ fontSize: '2.5rem', marginBottom: '1rem' }}>About Mercury</h1>
            ...
            It has a rocky surface covered with craters and experiences extreme temperatures due to its thin atmosphere.
            Despite being so close to the Sun, it is not the hottest planet—Venus holds that title.
            </p>
